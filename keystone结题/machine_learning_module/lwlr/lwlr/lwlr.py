...
xArr, yArr,zArr = loadDataSet('tcp2_3d_reverse_whole_1000_new_1.txt')
xArr1=[];yArr1=[];yArr2=[];zArr1=[];zArr2=[]
zArr2=zArr[:]
xArr1=xArr[:];yArr1=yArr[:];yArr2=yArr[:];zArr1=zArr[:]#yArr 2000
resultArr=[]
while zArr:resultArr.append([xArr.pop(0),zArr.pop(0)])
#变换数据
#while yArr:testArr.append([yArr2.pop(0),yArr1.pop(0)])


###SVM回归——红####
from sklearn import svm
model_SVR = svm.SVR(C=30)
result_SVR,score_SVR=try_different_method(model_SVR)
#result=[];result_SVR1=[]
#result_SVR1=result_SVR[:]
#while result_SVR:result.all([result_SVR.pop(0),result_SVR1.pop(0)])
####决策树回归——绿####
...
#ax1 = Axes3D(ax)
#ax1.plot_trisurf(xArr1,zArr1,result_SVR)
